...
cls
echo ===========================警告==================================
echo 由于测试版本的不确定因素，请确保您有OPPO的9008售后授权后再开始刷写
echo =================================================================

echo ==========================WARNING================================
echo Due to the uncertainty of the beta version, please make sure you have OPPO's customer service authorization before starting flashing
echo =================================================================
